...
/*  componentDidMount() {
    document.querySelector('books-authors').innerHTML = this.props.books[0].authors;
...
*/
  ...
  render() {
    // Perform a check to see if props were loaded
    if(this.props.books.length = 7) {
      console.log(this.props)
